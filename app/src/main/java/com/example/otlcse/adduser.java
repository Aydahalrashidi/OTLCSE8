...
public class adduser extends AppCompatActivity {
    EditText signupFName, signupLName, signupPhone, signupNID, signupEmail, signupUsername, addVehicle ,signupPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String Vehicle = addVehicle.getText().toString() ;
                ...
                if (Vehicle.isEmpty()) {
                    addVehicle.setError("Vehicle cannot be empty");
                }
                if (phone.isEmpty()) {
                ...
                Pattern Vehicle_pattern = Pattern.compile(letter_regix);
                Matcher Vehicle_matcher = Vehicle_pattern.matcher(Vehicle.toString());


                if (!Vehicle_matcher.matches()) {
                    addVehicle.setError("Should be letter format");
                    pattern_status = false;
                }
                ...
                if (!username.isEmpty() & !first_name.isEmpty() & !password.isEmpty() & !email.isEmpty() & !last_name.isEmpty() & !Vehicle.isEmpty() &!phone.isEmpty() & !nid.isEmpty() & wrco == 1 & pattern_status) {
                            ...
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        HelperClass helperClass = new HelperClass(first_name, last_name, phone, nid, email,username, Vehicle , MD5String, user.getUid());
                                        reference.child(user.getUid()).setValue(helperClass);
                                        Toast.makeText(adduser.this, "You have added  User successfully!", Toast.LENGTH_SHORT).show();

                                    } else {

                                        // Registration failed
                                        Toast.makeText(adduser.this, "Error: added  User", Toast.LENGTH_LONG).show();
                                    }
                                }
                            });
                }
